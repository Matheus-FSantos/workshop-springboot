...
import io.github.MatheusFSantos.Entities.Payment;
...
public class TestConfiguration implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem orderItem3 = new OrderItem(order3, product2, 1, product2.getPrice());
		OrderItem orderItem4 = new OrderItem(order2, product5, 2, product2.getPrice());
	
		orderItemRepository.saveAll(Arrays.asList(orderItem1, orderItem2, orderItem3, orderItem4));
		
		
		Payment payment1 = new Payment(null, Instant.parse("2023-02-19T21:13:07Z"), order1);
